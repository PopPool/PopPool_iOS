...
private extension SignUpVC {
    ...
    func bind() {
        ...
        let input = SignUpVM.Input(
            ...
            event_step2_availableNickName: step2_ContentView.validationTextField.stateObserver,
        ...
        output.step2_isDuplicate
            ...
            .subscribe { (owner, isDuplicate) in
                guard let nickName = owner.step2_ContentView.validationTextField.textField.text else { return }
